        ...
        <SafeAreaView style={GlobalStyle.droidSafeArea}>
            <ScrollView style={styles.contain}>
                ...
                <View style={styles.imageContain}>
                    <Image source={{ uri: path + product.item.thumbnail }} style={{ resizeMode: 'contain', width: '100%', height: 400 }} />
                </View>
                <View styles={styles.detialContainer}>
                    <View style={{ marginLeft: 20, marginTop: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Text numberOfLines={2} style={{ fontSize: 20, fontWeight: 'bold', width: 250 }}>{product.item.product_title}
                        </Text>
                    </View>
